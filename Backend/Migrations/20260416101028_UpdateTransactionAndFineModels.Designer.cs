...
namespace Backend.Migrations
{
    ...
    [Migration("20260416101028_UpdateTransactionAndFineModels")]
    partial class UpdateTransactionAndFineModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.Transaction", b =>
                {
                    ...
                    b.Property<int>("Status")
                        ...
                        .HasComment("Borrowed/Returned/Overdue/Cancelled");
            ...
            modelBuilder.Entity("Backend.Models.BorrowPolicy", b =>
                {
                    b.HasOne("Backend.Models.AspNetRole", "AspNetRole")
                        .WithMany()
                        .HasForeignKey("AspNetRoleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
